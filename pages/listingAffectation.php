            ...
            <div class="milieu" style="margin-top:30px ;">
                <table class="table" >
                    ...
                    <tr>
                        ...
                        $stmt = $connect->query ("SELECT * FROM affecter");
                        while ($row = $stmt->fetch()) { ?>
                    <tr>
                        <td><?php echo $row["NumAff"]; ?></td>
                        <td><?php echo $row["IdVigile"]; ?></td>
                        <td><?php echo $row["CodeLoc"]; ?></td>
                        <td><?php echo $row["DateDebut"]; ?></td>
                        <td><?php echo $row["DateFin"]; ?></td>
                        <td><?php echo $row["NbHeure"]; ?></td>
                        ...
                        width:100%;border:none;outline:none;padding:8px 0 8px 15px;font-size:15px;cursor:pointer;"
                                href="../pages/modifAffectation.php?NumAff=<?php echo $row['NumAff']; ?>">
                                Modifier</a></td>
                        <td><a class="btn"
                        style="background-color:#2b94e5; color:black;border-radius:30px;
                        width:100%;border:none;outline:none;padding:8px 0 8px 15px;font-size:15px;cursor:pointer;"
                                href="../traitements/suppAffectation.php?NumAff=<?php echo $row['NumAff']; ?>"
